...
Pod::Spec.new do |s|
  s.name             = 'AFtestLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AFtestLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Alexandru Dranca/AFtestLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Alexandru Dranca' => 'alexandru.dranca@fortech.ro' }
  s.source           = { :git => 'https://github.com/Alexandru Dranca/AFtestLib.git', :tag => s.version.to_s }
